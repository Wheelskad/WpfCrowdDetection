...
namespace WpfCrowdDetection.Model
{
    public class DetectionInfo
    {
        ...
        //TODO :: Delete
        public DetectionInfo(Image<Bgr, byte> image,
            ICollection<Rectangle> rectangles,
            ICollection<string> genders,
            ICollection<double> ages,
            ICollection<double> smiles,
            ICollection<FacialHair> facialHair,
            ICollection<Glasses> glasses,
            ICollection<Accessory[]> accessories,
            ICollection<EmotionScores> emotions
            )
        {
            Image = image;
            Rectangles = rectangles;
